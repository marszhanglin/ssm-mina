...
<head>
	...
	<title>MinaSSM | Login Page</title>
...
<body class="login">
	...
	<div class="logo">
		...
		<img src="media/image/mina/log-minassm.png" alt="" /> 
	...
	<div class="content">
		...
		<form class="form-vertical login-form" onsubmit="return false;" >
			...
			<h3 class="form-title">valodate写法LOW到不行</h3>
	...
	<script src="<%=basePath%>mina/login/login.js" type="text/javascript"></script>      
